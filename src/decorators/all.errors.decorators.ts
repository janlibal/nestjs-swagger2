...
export function OkResponse<TModel extends Type<unknown>>(
  model: TModel,
  type: 'array' | 'object',
  status: number,
  description?: string,
...
export function BadRequestErrorNew<TModel extends Type<unknown>>(
  model: TModel,
  type: 'array' | 'object',
  status: number,
  description?: string,
...
export function UnauthorizedErrorNew<TModel extends Type<unknown>>(
  model: TModel,
  type: 'array' | 'object',
  status: number,
  description?: string,
...
export function UnprocessableEntityErrorNew<TModel extends Type<unknown>>(
  model: TModel,
  type: 'array' | 'object',
  status: number,
  description?: string,
...
export function ConflictErrorNew<TModel extends Type<unknown>>(
  model: TModel,
  type: 'array' | 'object',
  status: number,
  description?: string,
...
export function NotFoundErrorNew<TModel extends Type<unknown>>(
  model: TModel,
  type: 'array' | 'object',
  status: number,
  description?: string,
...
export function InternalServerNew<TModel extends Type<unknown>>(
  model: TModel,
  type: 'array' | 'object',
  status: number,
  description?: string,
